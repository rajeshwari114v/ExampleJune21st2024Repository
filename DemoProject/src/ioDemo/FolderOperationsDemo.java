package DemoProject.src.ioDemo;
...
public class FolderOperationsDemo {
    ...
    {
        File f1=new File("C:\\Demo\\HelloWorld");
        boolean v1=f1.mkdir();
    ...
    {
        File f1=new File("C:\\Demo\\Hello1\\Hello2\\Hello3\\Hello4");
    ...
    {
        File f1=new File("C:\\Demo\\HelloWorld");
        File f2=new File("C:\\Demo\\HelloWorldNew");
    ...
    {
        File f1=new File("C:\\Demo\\Hello1");
